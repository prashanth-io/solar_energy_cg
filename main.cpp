...
void display6(void)
{
	...
	bitmap_output(-36, 12, "LOKESH-OF", GLUT_BITMAP_TIMES_ROMAN_24);
	bitmap_output(20, 41, "NO POWER IN THIS HOUSE..", GLUT_BITMAP_TIMES_ROMAN_24);
	bitmap_output(-4, 25, "PVS-HOTEL", GLUT_BITMAP_TIMES_ROMAN_24);
	bitmap_output(27, 24, "ABHI", GLUT_BITMAP_TIMES_ROMAN_24);
